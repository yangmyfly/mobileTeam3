...
//            hmap.put("Version", Version);
    ...
    static void navigation(final RoutingContext routingContext) {
        ...
        double distanceA = getDistance(Integer.parseInt(rssiA), Integer.parseInt(txPowerA));
        ...
        double distanceB = getDistance(Integer.parseInt(rssiB), Integer.parseInt(txPowerB));
        ...
        double distanceC = getDistance(Integer.parseInt(rssiC), Integer.parseInt(txPowerC));
